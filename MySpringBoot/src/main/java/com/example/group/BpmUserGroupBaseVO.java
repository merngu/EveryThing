...
/**
 * FileName: BpmUserGroupBaseVO
 * Author: bai
 * Date:   20242024/5/14下午5:25
 * Description: 用户组 Base VO，提供给添加、修改、详细的子 VO 使用
...
public class BpmUserGroupBaseVO {
    ...
    @Schema(description = "组名", requiredMode = Schema.RequiredMode.REQUIRED , example = "测试组")
